...
export const MessageStatusHook = (props) => {
    ...
    return (
        <Modal
            ...
            <View style={[styles.main, {}]}>
                ...
                <Text style={{ fontWeight: "600", fontSize: 25, paddingBottom: 12 }}>Message Status Webhook</Text>
...
export default MessageStatusHook